...
const MergedArticle: React.FC<MergedArticleProps> = ({ mergedArticle }) => {
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
      ...
      <h3 className="text-xl font-semibold mb-3 text-gray-800">{mergedArticle.title}</h3>
      ...
      <div className="mt-4">
        <h4 className="text-sm font-semibold text-gray-500 mb-2">Sources Considered:</h4>
